...
const ProfileApp = () => {
  return (
    <div className='w-full h-full @container'>
      <div className='grid grid-cols-1 @3xl:grid-cols-5 grid-rows-[repeat(3,minmax(min-content,1fr))] gap-[0.8vw] p-4'>
        <AppSection colSpan={3}>
          <img src={ProfileIconNoHi} alt='' className='rounded-xl max-h-[36vh] max-w-[36vh]' />
          <div className='flex flex-col gap-y-4'>
            <div>
              <h1>Megan Yi</h1>
              <p className='italic'>currently soon to be graduate</p>
            </div>
            <div>
              <h3>Bio:</h3>
              <p>
